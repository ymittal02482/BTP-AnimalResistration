...
contract DogNFT is ERC721Full {
    constructor() public ERC721Full("AnimalRegistryToken", "ANIMAL") {}

    modifier onlyPuppyOwner(address puppyOwner,uint tokenId){
        require(ownerOf(tokenId) == msg.sender, "Only ANIMAL token owner can call this function.");
        require(puppyOwner == msg.sender, "You are not a registered owner of this animals.");
        _;
    }
